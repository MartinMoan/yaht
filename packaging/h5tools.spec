...
#
#   dist/H5Viewer-standalone(.exe) "onefile" -- a single self-contained
...
# gathers it plus a.binaries/a.datas into dist/H5Viewer/.
exe = EXE(
    pyz,
    a.scripts,
    [],
...
# differently from "H5Viewer" so the two don't collide on disk (on Linux,
